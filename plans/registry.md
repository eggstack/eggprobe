...
| Native path/host diagnostics | active | M001/M002 closed; C002 upstream ICMP enablement conditionally closed on the upstream-ready branch; C003/M003 blocked on a crates.io publication; M004 ready; M005/M006 blocked | `plans/subsystems/native-path-host-diagnostics-roadmap.md` |
...
| Native path/host diagnostics corrective | C002 ping-async upstream ICMP contract enablement | conditionally closed | `plans/implementation/native-path-host-diagnostics-corrective/002-ping-async-upstream-icmp-contract-enablement.md` | Upstream-ready additive branch landed (`eggprobe/c002-additive-evidence` at `968cdec` from `b3769ef`); PR description prepared; awaiting upstream merge + crates.io publication. Closure `plans/closure/native-path-host-diagnostics-corrective/002-status.md`. |
...
| Native diagnostics corrective | C003 published ICMP backend adoption qualification | blocked | `plans/implementation/native-path-host-diagnostics-corrective/003-published-icmp-backend-adoption-qualification.md` | C002 conditionally closed (additive upstream-ready branch landed at `968cdec` from `b3769ef`); remaining half of the readiness gate is a crates.io release of the accepted surface |
...
12. ~~Execute **Native corrective C002**~~ — conditionally closed on the upstream-ready branch (`eggprobe/c002-additive-evidence` at `968cdec` from upstream `b3769ef`); PR description prepared; closure `plans/closure/native-path-host-diagnostics-corrective/002-status.md`. Remaining external work is upstream review/merge and crates.io publication of the accepted additive surface.
